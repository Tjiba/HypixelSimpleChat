...
object Collapse {
    ...
    /** Barre de décoration : Hypixel encadre chaque pavé d'annonce de la même. La replier
     *  arracherait le cadre du pavé pour un "(x2)" qui n'apprend rien — et ces annonces sont rares. */
    private val DECOR = Regex("^[^\\w\\s]{8,}$")
    ...
    private fun countable(key: String) = key.isNotBlank() && !DECOR.matches(key)
}
