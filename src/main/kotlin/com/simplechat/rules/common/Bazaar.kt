...
object Bazaar {
    ...
    val rules = rules(BAZAAR) {
        ...
        rule("bazaar-bought", RuleAction.HIDE,
            ...
            compact = { "§6BZ §a+ §f${it[1]}x ${it[2]} §7· §c-${Fmt.shortNum(it[3])}" },
        ...
        rule("bazaar-sold", RuleAction.HIDE,
            ...
            compact = { "§6BZ §c- §f${it[1]}x ${it[2]} §7· §a+${Fmt.shortNum(it[3])}" },
        ...
        rule("bazaar-claimed", RuleAction.HIDE,
            ...
            compact = { "§6BZ §a+${Fmt.shortNum(it[1])} §7· §f${it[2]}x ${it[3]}" },
